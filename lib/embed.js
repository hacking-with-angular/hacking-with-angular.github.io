!function (e, t, s) {
    ...
    if (o.extend = function (e, t) {
        ...
        et.commentList = function (e) {
            ...
            return t += '</div><div class="ds-actions">', e.service ? t += tt({"service[]": e.service}) : (t += '<label><input type="checkbox" name="service[]" value="weibo" ',="" nt.data.social_uid.weibo="" &&="" (t="" +=" checked="checked"" ),="" t="" ,="" nt.data.social_uid.qq="" z.repost="" "<="" button=""></label></div></form>"
            ...
            return e.user_vote > 0 && (t += " ds-thread-liked"),="" t="" +=""><span class="ds-icon ds-icon-heart"></span> <span class="ds-thread-like-text">" ,="" target="_blank" rel="external"> 0 ? "已喜欢" : "喜欢", t += '<span class="ds-thread-cancel-like">取消喜欢</span></a><span class="ds-like-panel"></span></div>'
            ...
            if (t += '<li class="ds-post" data-post-id="' + s.post_id + '"><div class="ds-post-self" data-post-id="' + s.post_id + '" data-thread-id="' + s.thread_id + '" data-root-id="' + s.root_id + '" data-source="' + s.source + '"><div class="ds-avatar" ',="" r.user_id="" &&="" (t="" +=" data-user-id="" '"'),="" t="" et.avatar(r),="" s.sourcename[s.source]="" ,="" r.url="" ?="" (r.qqt_account="" ||="" "")="" '"="" href="' + u(r.url) + '" this.href="" + a() + "/user-url/?user_id=" + r.user_id + "" ;\""),="" u(r.name)="" "<="" a="">") : (t += '<span class="ds-user-name" ',="" r.user_id="" &&="" (t="" +=" data-user-id="" '"'),="" t="" (r.qqt_account="" ||="" "")="" '"="">' + u(r.name) + "</span>"), t += "</div>", 1 == i.max_depth && i.show_context && s.parents.length) {
                ...
                if (n)for (var o, d = -1, l = n.length - 1; l > d;)o = n[d += 1], 1 == d && s.parents.length > 2 && (t += '<li class="ds-ctx-entry"><a href="javascript:void(0);" class="ds-expand" target="_blank" rel="external">还有' + (s.parents.length - 2) + "条评论</a></li>"), t += et.ctxPost({
                    post: o,
                    index: d,
            ...
            return e.options.show_reposts && e.thread.reposts && (t += '<li class="ds-tab"><a class="ds-comments-tab-repost" href="javascript:void(0);" target="_blank" rel="external"></a></li>'), t += " ", e.options.show_weibo && e.thread.weibo_reposts && (t += '<li class="ds-tab"><a class="ds-comments-tab-weibo" href="javascript:void(0);" target="_blank" rel="external"></a></li>'), t += " ", e.options.show_qqt && e.thread.qqt_reposts && (t += '<li class="ds-tab"><a class="ds-comments-tab-qqt" href="javascript:void(0);" target="_blank" rel="external"></a></li>'), t += "</ul></div>"
            ...
            var t = '<div class="ds-replybox"><a class="ds-avatar" ';="" if="" (t="" +="r()" ?="" '="" href="javascript:void(0);" onclick="return false" :="" settings="" avatar="" "="" x(t())="" '"="" target="_blank" title="设置头像" ',="" t="" et.avatarimg(nt.data)="" '<="" a=""><form method="post">' + tt(e.params) + '<div class="ds-textarea-wrapper ds-rounded-top"><textarea name="message" title="Ctrl+Enter快捷提交" placeholder="' + u(z.leave_a_message) + '"></textarea><pre class="ds-hidden-text"></pre>', t += "</div>", t += '<div class="ds-post-toolbar"><div class="ds-post-options ds-gradient-bg"><span class="ds-sync">', !r() && nt.data.repostOptions) {
                t += '<input id="ds-sync-checkbox', e.inline && (t += " -inline"),="" t="" +="" type="checkbox" name="repost" " ,="" e.checked="" &&="" (t="" ),="" e.repostarray.join(",")="" '"=""> <label for="ds-sync-checkbox', e.inline && (t += " -inline"),="" t="" +="">" z.share_to="" "<="" label="">";
                for (var s in nt.data.repostOptions)t += et.serviceIcon(s, !nt.data.repostOptions[s])
            }
            return t += "</label></span>", t += "</div>", t += '<button class="ds-post-button" type="submit">' + u(z.post) + '</button><div class="ds-toolbar-buttons">', e.options.use_smilies && (t += '<a class="ds-toolbar-button ds-add-emote" title="插入表情"></a>'), e.options.use_images && e.options.parse_html_enabled && (t += '<a class="ds-toolbar-button ds-add-image" title="插入图片"></a>'), t += "</div></div>", t += "</form></a></div>"
            ...
            if (s)for (var a, i = -1, r = s.length - 1; r > i;)a = s[i += 1], t += ' <li> <a class="ds-' + a + '" href="javascript:void(0);" data-service="' + a + '" target="_blank" rel="external">' + S.sourceName[a] + "</a> </li> ";
            ...
            return e += nt.data.url ? '<a class="ds-visitor-name" href="' + u(nt.data.url) + '" target="_blank">' + u(nt.data.name) + "</a>" : '<span class="ds-visitor-name">' + u(nt.data.name) + "</span>", e += '<a class="ds-unread-comments-count" href="javascript:void(0);" title="新回复" target="_blank" rel="external"></a></div></div>'
            ...
            function U(e, t) {
                ...
                function o() {
                    ...
                    if (a.hasClass("ds-reply-active"))h.el.fadeOut(200, function () {
                        ...
                        h ? h.actionsBar.removeClass("ds-reply-active") : (h = new st.Replybox(e), h.render(!0).el.addClass("ds-inline-replybox").detach()), h.el.find("[name=parent_id]").val(i.attr("data-post-id")), h.el.show().appendTo(s.closest(".ds-ctx-body, .ds-comment-body")).find("textarea").focus(), h.actionsBar = a.addClass("ds-reply-active"), t.max_depth <= 1="" ?="" h.postlist="e.postList.el" :="" (h.postlist="i.siblings(".ds-children")," h.postlist[0]="" ||="" class="ds-children">').insertAfter(i)))
                    }
                    return !1
                }
